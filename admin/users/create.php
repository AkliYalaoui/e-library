    ...
    <div class="form-container">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post">
            ...
            <div class="form-group">
                <input type="text" class="input" name="name" id="name" placeholder="name's length between 4 and 20 char" value="<?php echo $_POST['name'] ?? ''?>">
            ...
            <div class="form-group">
                <input type="email" class="input" name="email" id="email" placeholder="example: foo@bar.com" value="<?php echo $_POST['email'] ?? ''?>">
            ...
            <div class="form-group">
                <input type="password" class="input" name="password" id="password" placeholder="strong password between 6 and 255 char">
                <i class="fa fa-key"></i>
            </div>
            ...
            <div class="form-group">
                <input type="password" class="input" name="password_confirmation" id="password_confirmation" placeholder="strong password between 6 and 255 char">
                <i class="fa fa-key"></i>
            </div>
