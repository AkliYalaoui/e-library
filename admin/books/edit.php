...
<div class="flex container form-auth admin-container">
  <div class="form-container">
    ...
    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'])."?id=".$book->id ?>" method="post"
      ...
      <div class="form-group">
        <input type="number" required class="input" name="isbn" id="isbn"
          value="<?php echo $_POST['isbn'] ?? $book->isbn?>">
      ...
      <div class="form-group">
        <input type="number" required class="input" name="pages" id="pages"
          value="<?php echo $_POST['pages'] ?? $book->pages?>">
        <i class="fa fa-id-card"></i>
      </div>
